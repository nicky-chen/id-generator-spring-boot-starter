/*
 * File Name:EnhancedServiceLoader is created on 2019/4/12下午6:57 by nicky_chen
 *
...
import com.nicky.exception.EnhancedServiceNotFoundException;
import com.nicky.loadbalance.Initialize;

/**
 * @description:
 *
 * @author nicky_chin
 * @date: 2019/4/12 下午6:57
 *
 * @since JDK 1.8
 */
    ...
    private static <S> S loadFile(Class<S> service, String activateName, ClassLoader loader) {
        try {
            ...
            if (e instanceof EnhancedServiceNotFoundException) {
                ...
                throw new EnhancedServiceNotFoundException(
                    "not found service provider for : " + service.getName() + " caused by " + ExceptionUtils.getMessage(e));
            }
        }
    }
